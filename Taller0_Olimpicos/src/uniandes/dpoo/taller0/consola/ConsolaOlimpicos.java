...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Pais segun atleta");
	}
	
	
	private void paisSegunAtleta() 
	{
		String nombre = input("Por favor ingrese el nombre del atleta que quiere buscar");
		
		String pais = calculadora.paisSegunAtleta(nombre);
		
		System.out.println("\n");
		
		System.out.println("El atleta con nombre " + nombre + " es de el pais: " + pais);
	}
	/**
